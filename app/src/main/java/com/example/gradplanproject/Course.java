...
public class Course {
     ...
     */
    List<String> getSingleDaysArray() {
    ...
    ArrayList<Map<String, String>> getInstructors() { return instructors; }
    ...
    ArrayList<Map<String, Object>> getSchedules() {
        return schedules;
    }

    public void setSchedules(ArrayList<Map<String, Object>> schedules) { this.schedules = schedules; }
